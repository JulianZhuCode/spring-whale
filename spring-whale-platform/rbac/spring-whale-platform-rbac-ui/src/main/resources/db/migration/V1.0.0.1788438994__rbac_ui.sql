...
VALUES ((SELECT id FROM rbac_menu WHERE code = 'system'), 'rbac', 'RBAC', 'menu.rbac', 'DIRECTORY', NULL, NULL, NULL,
        'shield', 1, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (code)
WHERE del_flag = 0 DO NOTHING;
...
INSERT INTO rbac_menu (parent_id, code, name, name_i18n_key, type, path, component, permission, icon, sort, visible,
                       status, version, del_flag, create_time, update_time)
VALUES ((SELECT id FROM rbac_menu WHERE code = 'rbac:user'), 'rbac:user:create', 'User Management Create', NULL,
        'BUTTON', NULL, NULL, 'rbac:user:create', NULL, 1, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ((SELECT id FROM rbac_menu WHERE code = 'rbac:user'), 'rbac:user:update', 'User Management Update', NULL,
        'BUTTON', NULL, NULL, 'rbac:user:update', NULL, 2, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ((SELECT id FROM rbac_menu WHERE code = 'rbac:user'), 'rbac:user:delete', 'User Management Delete', NULL,
...
INSERT INTO rbac_menu (parent_id, code, name, name_i18n_key, type, path, component, permission, icon, sort, visible,
                       status, version, del_flag, create_time, update_time)
VALUES ((SELECT id FROM rbac_menu WHERE code = 'rbac:role'), 'rbac:role:create', 'Role Management Create', NULL,
        'BUTTON', NULL, NULL, 'rbac:role:create', NULL, 1, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ((SELECT id FROM rbac_menu WHERE code = 'rbac:role'), 'rbac:role:update', 'Role Management Update', NULL,
        'BUTTON', NULL, NULL, 'rbac:role:update', NULL, 2, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ((SELECT id FROM rbac_menu WHERE code = 'rbac:role'), 'rbac:role:delete', 'Role Management Delete', NULL,
...
INSERT INTO rbac_menu (parent_id, code, name, name_i18n_key, type, path, component, permission, icon, sort, visible,
                       status, version, del_flag, create_time, update_time)
VALUES ((SELECT id FROM rbac_menu WHERE code = 'rbac:menu'), 'rbac:menu:create', 'Menu Management Create', NULL,
        'BUTTON', NULL, NULL, 'rbac:menu:create', NULL, 1, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ((SELECT id FROM rbac_menu WHERE code = 'rbac:menu'), 'rbac:menu:update', 'Menu Management Update', NULL,
        'BUTTON', NULL, NULL, 'rbac:menu:update', NULL, 2, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ((SELECT id FROM rbac_menu WHERE code = 'rbac:menu'), 'rbac:menu:delete', 'Menu Management Delete', NULL,
...
INSERT INTO rbac_menu (parent_id, code, name, name_i18n_key, type, path, component, permission, icon, sort, visible,
                       status, version, del_flag, create_time, update_time)
VALUES ((SELECT id FROM rbac_menu WHERE code = 'rbac:group'), 'rbac:group:create', 'Group Management Create', NULL,
        'BUTTON', NULL, NULL, 'rbac:group:create', NULL, 1, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ((SELECT id FROM rbac_menu WHERE code = 'rbac:group'), 'rbac:group:update', 'Group Management Update', NULL,
        'BUTTON', NULL, NULL, 'rbac:group:update', NULL, 2, 1, 1, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ((SELECT id FROM rbac_menu WHERE code = 'rbac:group'), 'rbac:group:delete', 'Group Management Delete', NULL,
